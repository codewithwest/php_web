...
@section('admin_main_content')
    ...
    <div class="d-flex wrap">
        ...
        <nav class="admin-nav flex-col">
            <a class="links center-content d-flex" href="/admin/dashboard/users">Users</a>
            <a class="links center-content d-flex" href="/admin/dashboard/quizzes">Quizzes</a>
            <a class="links center-content d-flex" href="/admin/dashboard/questions">Questions</a>
        </nav>
