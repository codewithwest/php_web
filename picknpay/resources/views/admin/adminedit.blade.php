...
@section('link_redirect')
    <a href="/store/admin/dashboard/admins" class="m-auto">All Admins</a>
@endsection
...
@section('auth_content')
    ...
    @foreach ($adminById as $key => $data)
        <form action="/store/admin/admins/update" class="sign-ind-form d-flex wrap j-sb m-auto" method="post">
            @csrf
